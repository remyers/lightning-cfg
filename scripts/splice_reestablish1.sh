...
alice_wait_for_state "NORMAL" 
bob_wait_for_state "CHANNELD_NORMAL"
check_log "Not sending final tx_complete for interop test: Disconnection with one side sending commit_sig" 1
check_log "Not sending commit_sig for interop test: Disconnection with one side sending commit_sig" 1
check_log "our peer aborted the splice attempt: ascii='next_funding_txid not recognized. Sending tx_abort.'" 1
check_funding_txid
check_funds 450000000 50000000
...
check_log "Not sending commit_sig for interop test: Disconnection with both sides sending commit_sig" 1
