...
echo == Test: "Disconnection after exchanging tx_signatures and both sides send commit_sig for channel update; revoke_and_ack not received"
alice-eclair-cli splicein --channelId=$CHANNEL_ID --amountIn=15009 >& /dev/null
sleep 10
alice_wait_for_state "NORMAL" 
...
check_log "Ignoring revoke_and_ack for interop test: Disconnection after exchanging tx_signatures and both sides send commit_sig for channel update; revoke_and_ack not received" 1
check_log "Ignoring commit sigs for interop test: Disconnection after exchanging tx_signatures and both sides send commit_sig for channel update; revoke_and_ack not received" 1
...
bob_wait_for_state "CHANNELD_NORMAL"
check_funding_txid
check_funds 415009000 100000000
